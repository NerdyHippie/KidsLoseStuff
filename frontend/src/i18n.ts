...
const en: Translations = {
  ...
  claimSubtitle: (d) => d ? `"${d}" — enter your child's initials and teacher's name. Faculty will drop it off at their homeroom.` : `Enter your child's initials and teacher's name. Faculty will drop it off at their homeroom.`,
...
const es: Translations = {
  ...
  claimSubtitle: (d) => d ? `"${d}" — ingrese las iniciales de su hijo/a y el nombre del maestro/a. El personal lo entregará en su salón de clases.` : `Ingrese las iniciales de su hijo/a y el nombre del maestro/a. El personal lo entregará en su salón de clases.`,
...
const pt: Translations = {
  ...
  claimSubtitle: (d) => d ? `"${d}" — insira as iniciais do seu filho/a e o nome do professor/a. A equipe entregará na sala de aula.` : `Insira as iniciais do seu filho/a e o nome do professor/a. A equipe entregará na sala de aula.`,
...
const am: Translations = {
  ...
  claimSubtitle: (d) => d ? `"${d}" — የልጅዎን ስም መነሻ ፊደላት እና የአስተማሪውን ስም ያስገቡ። ሠራተኞቹ ወደ ክፍላቸው ያደርሱታል።` : `የልጅዎን ስም መነሻ ፊደላት እና የአስተማሪውን ስም ያስገቡ። ሠራተኞቹ ወደ ክፍላቸው ያደርሱታል።`,
...
const uk: Translations = {
  ...
  claimSubtitle: (d) => d ? `"${d}" — введіть ініціали вашої дитини та ім'я вчителя. Персонал доставить до їхнього класу.` : `Введіть ініціали вашої дитини та ім'я вчителя. Персонал доставить до їхнього класу.`,
...
const ro: Translations = {
  ...
  claimSubtitle: (d) => d ? `"${d}" — introduceți inițialele copilului dvs. și numele profesorului. Personalul îl va livra la clasa lor.` : `Introduceți inițialele copilului dvs. și numele profesorului. Personalul îl va livra la clasa lor.`,
...
const zh: Translations = {
  ...
  checkLink: '请检查链接后重试。',
  claimTitle: '认领此物品',
  claimSubtitle: (d) => d ? `"${d}" — 请输入您孩子的姓名缩写和老师的名字。工作人员将把物品送到他们的教室。` : `请输入您孩子的姓名缩写和老师的名字。工作人员将把物品送到他们的教室。`,
...
const fr: Translations = {
  ...
  claimSubtitle: (d) => d ? `"${d}" — entrez les initiales de votre enfant et le nom de l'enseignant(e). Le personnel le livrera à leur salle de classe.` : `Entrez les initiales de votre enfant et le nom de l'enseignant(e). Le personnel le livrera à leur salle de classe.`,
...
const ko: Translations = {
  ...
  claimTitle: '이 물건 찾기',
  claimSubtitle: (d) => d ? `"${d}" — 자녀의 이름 이니셜과 선생님 이름을 입력하세요. 교직원이 담임 교실로 전달해 드립니다.` : `자녀의 이름 이니셜과 선생님 이름을 입력하세요. 교직원이 담임 교실로 전달해 드립니다.`,
...
const vi: Translations = {
  ...
  claimSubtitle: (d) => d ? `"${d}" — nhập chữ viết tắt tên con bạn và tên giáo viên. Nhân viên sẽ chuyển đến phòng học của các em.` : `Nhập chữ viết tắt tên con bạn và tên giáo viên. Nhân viên sẽ chuyển đến phòng học của các em.`,
